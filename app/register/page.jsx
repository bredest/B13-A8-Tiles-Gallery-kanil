...
// Simple Check icon SVG to match @gravity-ui/icons Check
const CheckIcon = () => (
        ...
        <div className="flex w-full max-w-[384px] mx-auto flex-col">
          ...
          <form onSubmit={handleRegister} className="flex flex-col gap-4">
            <div className="form-control w-full">
              <label className="label pb-1"><span className="label-text font-medium text-base-content/80">Name</span></label>
              <input 
                required 
                type="text" 
                name="name"
            ...
            <div className="form-control w-full">
              ...
              />
              {errors.email && (
                <label className="label pt-1 pb-0"><span className="label-text-alt text-error">{errors.email}</span></label>
              )}
            </div>
            ...
            <div className="form-control w-full">
              ...
              <input 
                ...
                className={`input input-bordered w-full bg-base-200 ${errors.password ? 'input-error' : ''}`} 
              />
              ...
              {errors.password && (
                <label className="label pt-1 pb-0"><span className="label-text-alt text-error">{errors.password}</span></label>
              )}
            </div>
